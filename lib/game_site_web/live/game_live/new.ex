defmodule GameSiteWeb.GameLive.New do
  use GameSiteWeb, :live_view
  alias GameSite.Games

  def mount(_params, _session, socket) do
    {:ok, assign(socket, changeset: Games.change_game(%Games.Game{}))}
  end

  def handle_event("save", params, socket) do
    Games.create_game(params)
    |> case do
  ...
  def render(assigns) do
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 40px;">
      ...
      <form phx-submit="save" style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
